...
export const cfg = {
  ...
  settings: {
    ...
    storm:  { bg: '#01010a', needle: 70, bgOpacity: 100 },
    ...
    pendulum:{ bg: '#030308', needle: 70, bgOpacity: 100 },
    particle:{ bg: '#030308', needle: 70, bgOpacity: 100 },
    bloom:   { bg: '#020806', needle: 70, bgOpacity: 100 },
    crystal: { bg: '#030308', needle: 70, bgOpacity: 100 },
    morse:   { bg: '#030308', needle: 70, bgOpacity: 100 },
    phyllo:  { bg: '#030308', needle: 70, bgOpacity: 100 },
    ink:     { bg: '#02030a', needle: 70, bgOpacity: 100 },
    bubble:  { bg: '#030308', needle: 70, bgOpacity: 100 },
    strings: { bg: '#030308', needle: 70, bgOpacity: 100 },
